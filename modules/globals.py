# modules/globals.py
# Shared runtime flags and default config used across handlers

from modules.vars import OWNER, CREDIT  # package-qualified import

# Runtime toggles
processing_request = False
cancel_requested = False

# Defaults used by captions/handlers
caption = "/cc1"
endfilename = "/d"
thumb = "/d"
CR = f"{CREDIT}"

# Tokens/placeholders (recommend: move to env and fetch in modules/vars.py)
