...
def register_youtube_handlers(bot: Client):
    ...
    async def y2t_handler(bot: Client, message: Message):
        editable = await message.reply_text("<blockquote><b>Send YouTube Website/Playlist link for convert in .txt file</b></blockquote>")
